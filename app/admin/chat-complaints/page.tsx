...
const complaints = [
  {
    ...
    status: "Pending",
    severity: "High",
    description: "The recruiter sent inappropriate messages asking for personal information outside the platform.",
  },
  {
    id: 2,
    title: "Spam messages",
    ...
    status: "Resolved",
    severity: "Medium",
    description: "The recruiter is sending repeated messages about unrelated job opportunities.",
  },
  {
    id: 3,
    title: "Harassment",
    ...
    status: "Under Review",
    severity: "High",
    description: "The supervisor is sending threatening messages after I declined to work on their project.",
  },
  {
    id: 4,
    ...
    status: "Pending",
    severity: "Low",
    description: "The recruiter provided misleading information about the project requirements.",
  },
]

export default function ChatComplaintsPage() {
  ...
  return (
    <AdminLayout activePage="chat-complaints">
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold text-gray-900">Chat Complaints</h1>
        </div>
        ...
        <Tabs defaultValue="all" className="mb-6" onValueChange={setActiveTab}>
          ...
          <TabsContent value="under review">
            <Card>
              <CardHeader>
                <CardTitle>Complaints Under Review</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
        ...
        <Dialog open={isComplaintDialogOpen} onOpenChange={setIsComplaintDialogOpen}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Review the complaint information</DialogDescription>
            </DialogHeader>
            {selectedComplaint && (
