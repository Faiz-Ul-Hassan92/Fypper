...
export default function SupervisorBotsPage() {
  ...
  const bots = [
    ...
    },
    {
      ...
      voice: "Male (UK)",
      avatar: "/placeholder.svg?height=80&width=80",
      description: "Specialized in research methodologies and academic writing.",
    },
    {
      id: "bot3",
      ...
      voice: "Female (AU)",
      avatar: "/placeholder.svg?height=80&width=80",
      description: "Helps with scheduling, task management, and student progress tracking.",
    },
    {
      id: "bot4",
      ...
      voice: "Male (US)",
      avatar: "/placeholder.svg?height=80&width=80",
      description: "Provides technical advice on programming and engineering topics.",
    },
  ]
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Configure and select AI assistants to help with your supervision tasks
          </p>
        </div>
      </div>
                ...
                <DialogContent>
                  ...
                  <div className="bg-muted p-4 rounded-md">
                    <p className="text-sm italic">
                      "Hello, I'm {bot.name}. I'm here to assist you with your supervision tasks. How can I help you
                      today?"
                    </p>
                  </div>
                  <DialogFooter>
